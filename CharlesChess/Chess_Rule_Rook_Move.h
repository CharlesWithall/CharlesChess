...
class Chess_Rule_Rook_Move : public Chess_Rule
{
public:
	std::vector<Chess_Tile*> Evaluate(Chess_Tile* const anOriginTile, Chess_Board* const aChessBoard) const override
	{
		...
		EvaluateTile(outVector, anOriginTile, aChessBoard, colour, 0, 1);
		EvaluateTile(outVector, anOriginTile, aChessBoard, colour, 1, 0);
		EvaluateTile(outVector, anOriginTile, aChessBoard, colour, 0, -1);
		EvaluateTile(outVector, anOriginTile, aChessBoard, colour, -1, 0);
